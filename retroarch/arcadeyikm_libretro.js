var EJS_Runtime = function (ModuelArgs) {
  var Module = ModuelArgs;
  var moduleOverrides = {};
  ...
  var DYNAMIC_BASE = 71406384,
    DYNAMICTOP_PTR = 66163344;
  ...
  function createWasm() {
    ...
    function instantiateArrayBuffer(receiver) {
      WebAssembly.instantiate(Module.wasmBinary, info).then(receiver, function(reason) {
  ...
  var ___tm_current = 66163360;
  var ___tm_timezone = (stringToUTF8('GMT', 66163408, 4), 66163408);
  function _tzset() {
  ...
  var asmLibraryArg = {
    ...
    Ra: _RWebCamStop,
    o: ___assert_fail,
    Re: ___cxa_allocate_exception,
    i: ___cxa_atexit,
    Qe: ___cxa_throw,
    De: ___map_file,
    oa: ___sys_fcntl64,
    Ne: ___sys_fstat64,
    Ie: ___sys_ftruncate64,
    Ke: ___sys_getcwd,
    Oe: ___sys_getdents64,
    Je: ___sys_getpid,
    Ge: ___sys_ioctl,
    Pe: ___sys_mkdir,
    Ce: ___sys_munmap,
    ...
    Ac: _emscripten_glGetVertexAttribPointerv,
    Cc: _emscripten_glGetVertexAttribfv,
    Bc: _emscripten_glGetVertexAttribiv,
    ...
    $b: _emscripten_glStencilOpSeparate,
    _b: _emscripten_glTexImage2D,
    Zb: _emscripten_glTexParameterf,
    Yb: _emscripten_glTexParameterfv,
    ...
    gc: _emscripten_set_keydown_callback_on_thread,
    Lb: _emscripten_set_keypress_callback_on_thread,
    Wb: _emscripten_set_keyup_callback_on_thread,
  ...
  var _free = (Module['_free'] = function () {
    return (_free = Module['_free'] = Module['asm']['pf']).apply(
      null,
      arguments,
    );
  });
  ...
  var _fflush = (Module['_fflush'] = function () {
    return (_fflush = Module['_fflush'] = Module['asm']['rf']).apply(
      null,
      arguments,
    );
  });
  ...
  var _main = (Module['_main'] = function () {
    return (_main = Module['_main'] = Module['asm']['xf']).apply(
      null,
      arguments,
    );
  });
  var _CheatEnable = (Module['_CheatEnable'] = function () {
    return (_CheatEnable = Module['_CheatEnable'] = Module['asm']['yf']).apply(
      null,
      arguments,
    );
  });
  ...
  var __get_tzname = (Module['__get_tzname'] = function () {
    return (__get_tzname = Module['__get_tzname'] = Module['asm']['Af']).apply(
      null,
      arguments,
    );
  });
  ...
  var stackSave = (Module['stackSave'] = function () {
    return (stackSave = Module['stackSave'] = Module['asm']['Ef']).apply(
      null,
      arguments,
    );
  });
  var stackRestore = (Module['stackRestore'] = function () {
    return (stackRestore = Module['stackRestore'] = Module['asm']['Ff']).apply(
      null,
      arguments,
    );
  });
  var stackAlloc = (Module['stackAlloc'] = function () {
    return (stackAlloc = Module['stackAlloc'] = Module['asm']['Gf']).apply(
      null,
      arguments,
    );
  });
  ...
  var dynCall_vi = (Module['dynCall_vi'] = function () {
    return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['If']).apply(
      null,
      arguments,
    );
  });
  var dynCall_vii = (Module['dynCall_vii'] = function () {
    return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['Jf']).apply(
      null,
      arguments,
    );
  });
  var dynCall_viii = (Module['dynCall_viii'] = function () {
    return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['Kf']).apply(
      null,
      arguments,
    );
  });
  var dynCall_i = (Module['dynCall_i'] = function () {
    return (dynCall_i = Module['dynCall_i'] = Module['asm']['Lf']).apply(
      null,
      arguments,
    );
  });
  var dynCall_ii = (Module['dynCall_ii'] = function () {
    return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Mf']).apply(
      null,
      arguments,
    );
  });
  var dynCall_iii = (Module['dynCall_iii'] = function () {
    return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['Nf']).apply(
      null,
      arguments,
    );
  });
  var dynCall_iiii = (Module['dynCall_iiii'] = function () {
    return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['Of']).apply(
      null,
      arguments,
    );
  });
  ...
  function run(args) {
    ...
    preRun();
    console.log('readyPromiseResolve', runDependencies)
    ...
    function doRun() {
      ...
      console.log('readyPromiseResolve', ABORT)
      if (ABORT) return;
      initRuntime();
      preMain();
