  ...
  return async function (moduleArg = {}) {
    ...
    async function createWasm() {
      function receiveInstance(instance, module) {
        ...
        registerTLSInit(wasmExports['Hi']);
        wasmTable = wasmExports['Ph'];
        wasmModule = module;
    ...
    var _PlatformEmscriptenGetSystemInfo = function () {
      ...
      var browser =
        1 +
        ['chrom', 'firefox', 'safari'].findIndex((i) => userAgent.includes(i));
      var os =
        1 +
        [/windows/, /linux|cros|android/, /iphone|ipad/, /mac os/].findIndex(
          (i) => i.test(userAgent),
        );
      return browser | (os << 16);
    };
    function PlatformEmscriptenUpdateMemoryUsage() {
      _platform_emscripten_update_memory_usage_cb(
        BigInt(performance.memory.usedJSHeapSize || 0),
        BigInt(performance.memory.jsHeapSizeLimit || 0),
      );
    ...
    function PlatformEmscriptenPowerStateChange(e) {
      _platform_emscripten_update_power_state_cb(
        true,
        Number.isFinite(e.target.dischargingTime)
          ? e.target.dischargingTime
          : 2147483647,
        e.target.level,
        e.target.charging,
      );
    ...
    var PlatformEmscriptenDoSetCanvasSize = async function (width, height) {
      ...
      await new Promise((r) => setTimeout(r, 50));
      var projX =
        ((expBX - expAX) * (width - oldWidth)) / (RPE.canvasWidth - oldWidth) +
        expAX;
      var projY =
        ((expBY - expAY) * (height - oldHeight)) /
          (RPE.canvasHeight - oldHeight) +
        expAY;
    ...
    function _PlatformEmscriptenSetCanvasSize(width, height) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(2, 0, 1, width, height);
    ...
    function _PlatformEmscriptenSetWakeLock(state) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(3, 0, 1, state);
    ...
    function _PlatformEmscriptenWatchCanvasSizeAndDpr(dpr) {
      ...
      RPE.observer = new ResizeObserver(function (e) {
        ...
        GROWABLE_HEAP_F64()[(dpr >>> 3) >>> 0] = window.devicePixelRatio;
    ...
    function _PlatformEmscriptenWatchFullscreen() {
      document.addEventListener(
        'fullscreenchange',
        function () {
          _platform_emscripten_update_fullscreen_state_cb(
    ...
    function _PlatformEmscriptenWatchWindowVisibility() {
      document.addEventListener(
        'visibilitychange',
        function () {
          _platform_emscripten_update_window_hidden_cb(
    ...
    function pthreadCreateProxied(pthread_ptr, attr, startRoutine, arg) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(4, 0, 1, pthread_ptr, attr, startRoutine, arg);
    ...
    function ___syscall_accept4(fd, addr, addrlen, flags, d1, d2) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(5, 0, 1, fd, addr, addrlen, flags, d1, d2);
      addr >>>= 0;
      addrlen >>>= 0;
      try {
    ...
    function ___syscall_poll(fds, nfds, timeout) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(21, 0, 1, fds, nfds, timeout);
      fds >>>= 0;
      try {
        var nonzero = 0;
    ...
    function ___syscall_readlinkat(dirfd, path, buf, bufsize) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(22, 0, 1, dirfd, path, buf, bufsize);
      path >>>= 0;
      buf >>>= 0;
      bufsize >>>= 0;
      try {
    ...
    function ___syscall_recvfrom(fd, buf, len, flags, addr, addrlen) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(23, 0, 1, fd, buf, len, flags, addr, addrlen);
      buf >>>= 0;
      len >>>= 0;
      addr >>>= 0;
      addrlen >>>= 0;
    ...
    function ___syscall_unlinkat(dirfd, path, flags) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(29, 0, 1, dirfd, path, flags);
      path >>>= 0;
      try {
        path = SYSCALLS.getStr(path);
        path = SYSCALLS.calculateAt(dirfd, path);
    ...
    function _alBufferData(bufferId, format, pData, size, freq) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(30, 0, 1, bufferId, format, pData, size, freq);
      pData >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alDeleteBuffers(count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(31, 0, 1, count, pBufferIds);
      pBufferIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alSourcei(sourceId, param, value) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(33, 0, 1, sourceId, param, value);
      switch (param) {
        case 514:
        case 4097:
        case 4098:
    ...
    function _alDeleteSources(count, pSourceIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(32, 0, 1, count, pSourceIds);
      pSourceIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alGenBuffers(count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(34, 0, 1, count, pBufferIds);
      pBufferIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alGenSources(count, pSourceIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(35, 0, 1, count, pSourceIds);
      pSourceIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alGetSourcei(sourceId, param, pValue) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(37, 0, 1, sourceId, param, pValue);
      pValue >>>= 0;
    ...
    function _alSourceQueueBuffers(sourceId, count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(39, 0, 1, sourceId, count, pBufferIds);
      pBufferIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alSourceUnqueueBuffers(sourceId, count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(41, 0, 1, sourceId, count, pBufferIds);
      pBufferIds >>>= 0;
      if (!AL.currentCtx) {
        return;
      }
    ...
    function _alcCloseDevice(deviceId) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(42, 0, 1, deviceId);
      deviceId >>>= 0;
      if (
    ...
    function _alcCreateContext(deviceId, pAttrList) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(43, 0, 1, deviceId, pAttrList);
      deviceId >>>= 0;
      pAttrList >>>= 0;
    ...
    function _alcDestroyContext(contextId) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(44, 0, 1, contextId);
      contextId >>>= 0;
    ...
    function _alcOpenDevice(pDeviceName) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(46, 0, 1, pDeviceName);
      pDeviceName >>>= 0;
      if (pDeviceName) {
    ...
    function _emscripten_async_wget2_data(
      ...
      function onerrorjs() {
        if (onerror) {
          ...
          ((a1, a2, a3, a4) => dynCall_viiii(onerror, a1, a2, a3, a4))(
            handle,
            userdata,
            http.status,
            statusText,
      ...
      http.onload = (e) => {
        if (
          ...
          if (onload)
            ((a1, a2, a3, a4) => dynCall_viiii(onload, a1, a2, a3, a4))(
              handle,
              userdata,
              buffer,
              byteArray.length,
      ...
      http.onprogress = (e) => {
        if (onprogress)
          ((a1, a2, a3, a4) => dynCall_viiii(onprogress, a1, a2, a3, a4))(
            handle,
            userdata,
            e.loaded,
    ...
    var getCanvasElementSize = (target) => {
      ...
      var size = [
        GROWABLE_HEAP_I32()[(w >>> 2) >>> 0],
        GROWABLE_HEAP_I32()[(h >>> 2) >>> 0],
      ];
      stackRestore(sp);
      return size;
    };
    ...
    function _emscripten_force_exit(status) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(52, 0, 1, status);
      ...
      preDrawHandleClientVertexAttribBindings: (count) => {
        ...
        for (var i = 0; i < GL.currentContext.maxVertexAttribs; ++i) {
          ...
          GLctx.bufferSubData(
            34962,
            0,
            GROWABLE_HEAP_U8().subarray(cb.ptr >>> 0, (cb.ptr + size) >>> 0),
          );
    ...
    function _glDrawElements(mode, count, type, indices) {
      ...
      if (!GLctx.currentElementArrayBufferBinding) {
        ...
        GLctx.bufferSubData(
          34963,
          0,
          GROWABLE_HEAP_U8().subarray(indices >>> 0, (indices + size) >>> 0),
        );
        if (count > 0) {
          for (var i = 0; i < GL.currentContext.maxVertexAttribs; ++i) {
            var cb = GL.currentContext.clientBuffers[i];
    ...
    function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(54, 0, 1, target, deferUntilInEventHandler);
      target >>>= 0;
      target = findEventTarget(target);
      if (!target) return -4;
      if (!target.requestPointerLock) {
    ...
    function _emscripten_set_devicemotion_callback_on_thread(
      ...
      callbackfunc >>>= 0;
      targetThread >>>= 0;
      return registerDeviceMotionEventCallback(
        2,
        userData,
        useCapture,
        callbackfunc,
    ...
    var fillPointerlockChangeEventData = (eventStruct) => {
      ...
      GROWABLE_HEAP_I8()[eventStruct >>> 0] = isPointerlocked;
    ...
    var registerTouchEventCallback = (
      ...
      var touchEventHandlerFunc = (e) => {
        ...
        for (let t of Object.values(touches)) {
          ...
          GROWABLE_HEAP_I32()[(idx32 + 8) >>> 0] =
            t.clientX - (targetRect.left | 0);
          GROWABLE_HEAP_I32()[(idx32 + 9) >>> 0] =
            t.clientY - (targetRect.top | 0);
          idx += 48;
          if (++numTouches > 31) {
            break;
          }
    ...
    function _emscripten_webgl_get_drawing_buffer_size(
      ...
      GROWABLE_HEAP_I32()[(width >>> 2) >>> 0] =
        GLContext.GLctx.drawingBufferWidth;
      GROWABLE_HEAP_I32()[(height >>> 2) >>> 0] =
        GLContext.GLctx.drawingBufferHeight;
      return 0;
    }
    ...
    function _environ_get(__environ, environ_buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(68, 0, 1, __environ, environ_buf);
      __environ >>>= 0;
      environ_buf >>>= 0;
      var bufSize = 0;
      var envp = 0;
    ...
    function _environ_sizes_get(penviron_count, penviron_buf_size) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(69, 0, 1, penviron_count, penviron_buf_size);
      penviron_count >>>= 0;
      penviron_buf_size >>>= 0;
    ...
    function _fd_read(fd, iov, iovcnt, pnum) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(71, 0, 1, fd, iov, iovcnt, pnum);
      iov >>>= 0;
      iovcnt >>>= 0;
      pnum >>>= 0;
      try {
    ...
    function _fd_seek(fd, offset, whence, newOffset) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(72, 0, 1, fd, offset, whence, newOffset);
    ...
    function _fd_write(fd, iov, iovcnt, pnum) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(73, 0, 1, fd, iov, iovcnt, pnum);
      iov >>>= 0;
      iovcnt >>>= 0;
      pnum >>>= 0;
      try {
    ...
    function _getaddrinfo(node, service, hint, out) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(74, 0, 1, node, service, hint, out);
      node >>>= 0;
      service >>>= 0;
      hint >>>= 0;
      out >>>= 0;
    ...
    var proxiedFunctionTable = [
      _proc_exit,
      exitOnMainThread,
      _PlatformEmscriptenSetCanvasSize,
      _PlatformEmscriptenSetWakeLock,
    ...
    var ASM_CONSTS = {
      ...
      1411661: ($0) => {
        if (
          Module.callbacks &&
          typeof Module.callbacks.setupCoreSettingFile === 'function'
        ) {
          Module.callbacks.setupCoreSettingFile(
      ...
      1412493: () => Atomics?.waitAsync?.toString().includes('[native code]'),
      1412562: ($0) => {
    ...
    function assignWasmImports() {
      wasmImports = {
        Ta: _PlatformEmscriptenGLContextEventInit,
        Fb: _PlatformEmscriptenGetSystemInfo,
        Va: _PlatformEmscriptenMemoryUsageInit,
        db: _PlatformEmscriptenPowerStateInit,
        Nb: _PlatformEmscriptenSetCanvasSize,
        Yb: _PlatformEmscriptenSetWakeLock,
        xb: _PlatformEmscriptenWatchCanvasSizeAndDpr,
        Ua: _PlatformEmscriptenWatchFullscreen,
        ob: _PlatformEmscriptenWatchWindowVisibility,
        x: ___assert_fail,
        pb: ___pthread_create_js,
        bb: ___syscall_accept4,
        ab: ___syscall_bind,
        $a: ___syscall_connect,
        l: ___syscall_fcntl64,
        Db: ___syscall_ftruncate64,
        ...
        Kb: __abort_js,
        zb: __emscripten_init_main_thread_js,
        fb: __emscripten_notify_mailbox_postmessage,
        qb: __emscripten_receive_on_main_thread_js,
        la: __emscripten_thread_cleanup,
        yb: __emscripten_thread_mailbox_await,
        Hb: __emscripten_thread_set_strongref,
        ...
        T: _alGetSourcei,
        La: _alSourcePlay,
        Ma: _alSourceQueueBuffers,
        Ka: _alSourceStop,
        ia: _alSourceUnqueueBuffers,
        Ga: _alcCloseDevice,
        Qa: _alcCreateContext,
        Ha: _alcDestroyContext,
        ja: _alcMakeContextCurrent,
        Ra: _alcOpenDevice,
        Jb: _clock_time_get,
        $: _emscripten_asm_const_int,
        U: _emscripten_asm_const_int_sync_on_main_thread,
        $g: _emscripten_asm_const_ptr,
        Nc: _emscripten_async_call,
        rh: _emscripten_async_wget2_data,
        ma: _emscripten_check_blocking_allowed,
        Ib: _emscripten_date_now,
        hc: _emscripten_exit_fullscreen,
        Nd: _emscripten_exit_pointerlock,
        Gb: _emscripten_exit_with_live_runtime,
        Mh: _emscripten_force_exit,
        ...
        Vg: _emscripten_glBindAttribLocation,
        Ug: _emscripten_glBindBuffer,
        ...
        Lc: _emscripten_glClearBufferfi,
        Mc: _emscripten_glClearBufferfv,
        Pc: _emscripten_glClearBufferiv,
        Oc: _emscripten_glClearBufferuiv,
        Hg: _emscripten_glClearColor,
        Fg: _emscripten_glClearDepthf,
        Eg: _emscripten_glClearStencil,
        xc: _emscripten_glClientWaitSync,
        ae: _emscripten_glClipControlEXT,
        ...
        Jc: _emscripten_glCopyBufferSubData,
        ...
        gg: _emscripten_glDisableVertexAttribArray,
        fg: _emscripten_glDrawArrays,
        Cc: _emscripten_glDrawArraysInstanced,
        _g: _emscripten_glDrawArraysInstancedANGLE,
        ...
        ah: _emscripten_glDrawBuffersWEBGL,
        eg: _emscripten_glDrawElements,
        Bc: _emscripten_glDrawElementsInstanced,
        Zg: _emscripten_glDrawElementsInstancedANGLE,
        ...
        Of: _emscripten_glGetAttribLocation,
        Nf: _emscripten_glGetBooleanv,
        ...
        Jf: _emscripten_glGetFramebufferAttachmentParameteriv,
        tc: _emscripten_glGetInteger64i_v,
        vc: _emscripten_glGetInteger64v,
        md: _emscripten_glGetIntegeri_v,
        If: _emscripten_glGetIntegerv,
        Sb: _emscripten_glGetInternalformativ,
        _b: _emscripten_glGetProgramBinary,
        Gf: _emscripten_glGetProgramInfoLog,
        Hf: _emscripten_glGetProgramiv,
        gh: _emscripten_glGetQueryObjecti64vEXT,
        ih: _emscripten_glGetQueryObjectivEXT,
        fh: _emscripten_glGetQueryObjectui64vEXT,
        Hd: _emscripten_glGetQueryObjectuiv,
        hh: _emscripten_glGetQueryObjectuivEXT,
        Id: _emscripten_glGetQueryiv,
        jh: _emscripten_glGetQueryivEXT,
        Ff: _emscripten_glGetRenderbufferParameteriv,
        gc: _emscripten_glGetSamplerParameterfv,
        ic: _emscripten_glGetSamplerParameteriv,
        Cf: _emscripten_glGetShaderInfoLog,
        Bf: _emscripten_glGetShaderPrecisionFormat,
        Af: _emscripten_glGetShaderSource,
        Df: _emscripten_glGetShaderiv,
        zf: _emscripten_glGetString,
        Kc: _emscripten_glGetStringi,
        uc: _emscripten_glGetSynciv,
        yf: _emscripten_glGetTexParameterfv,
        xf: _emscripten_glGetTexParameteriv,
        gd: _emscripten_glGetTransformFeedbackVarying,
        Gc: _emscripten_glGetUniformBlockIndex,
        Ic: _emscripten_glGetUniformIndices,
        uf: _emscripten_glGetUniformLocation,
        wf: _emscripten_glGetUniformfv,
        vf: _emscripten_glGetUniformiv,
        _c: _emscripten_glGetUniformuiv,
        ed: _emscripten_glGetVertexAttribIiv,
        dd: _emscripten_glGetVertexAttribIuiv,
        qf: _emscripten_glGetVertexAttribPointerv,
        sf: _emscripten_glGetVertexAttribfv,
        rf: _emscripten_glGetVertexAttribiv,
        pf: _emscripten_glHint,
        ...
        ac: _emscripten_glPauseTransformFeedback,
        df: _emscripten_glPixelStorei,
        $d: _emscripten_glPolygonModeWEBGL,
        cf: _emscripten_glPolygonOffset,
        be: _emscripten_glPolygonOffsetClampEXT,
        Zb: _emscripten_glProgramBinary,
        Xb: _emscripten_glProgramParameteri,
        lh: _emscripten_glQueryCounterEXT,
        Vd: _emscripten_glReadBuffer,
        bf: _emscripten_glReadPixels,
        af: _emscripten_glReleaseShaderCompiler,
        $e: _emscripten_glRenderbufferStorage,
        vd: _emscripten_glRenderbufferStorageMultisample,
        $b: _emscripten_glResumeTransformFeedback,
        _e: _emscripten_glSampleCoverage,
        kc: _emscripten_glSamplerParameterf,
        jc: _emscripten_glSamplerParameterfv,
        mc: _emscripten_glSamplerParameteri,
        lc: _emscripten_glSamplerParameteriv,
        Ze: _emscripten_glScissor,
        Xe: _emscripten_glShaderBinary,
        We: _emscripten_glShaderSource,
        Ve: _emscripten_glStencilFunc,
        Ue: _emscripten_glStencilFuncSeparate,
        Te: _emscripten_glStencilMask,
        Se: _emscripten_glStencilMaskSeparate,
        Re: _emscripten_glStencilOp,
        Qe: _emscripten_glStencilOpSeparate,
        Pe: _emscripten_glTexImage2D,
        Td: _emscripten_glTexImage3D,
        Oe: _emscripten_glTexParameterf,
        ...
        Be: _emscripten_glUniform2i,
        Ae: _emscripten_glUniform2iv,
        ...
        ve: _emscripten_glUniform4f,
        ue: _emscripten_glUniform4fv,
        te: _emscripten_glUniform4i,
        se: _emscripten_glUniform4iv,
        ...
        Yg: _emscripten_glVertexAttribDivisorANGLE,
        Qb: _emscripten_glVertexAttribDivisorARB,
        _d: _emscripten_glVertexAttribDivisorEXT,
        Rb: _emscripten_glVertexAttribDivisorNV,
        cd: _emscripten_glVertexAttribI4i,
        ad: _emscripten_glVertexAttribI4iv,
        bd: _emscripten_glVertexAttribI4ui,
        $c: _emscripten_glVertexAttribI4uiv,
        fd: _emscripten_glVertexAttribIPointer,
        de: _emscripten_glVertexAttribPointer,
        ce: _emscripten_glViewport,
        wc: _emscripten_glWaitSync,
        Cd: _emscripten_html5_remove_all_event_listeners,
        hb: _emscripten_num_logical_cores,
        Nh: _emscripten_pause_main_loop,
        sc: _emscripten_request_fullscreen,
        Yd: _emscripten_request_pointerlock,
        eb: _emscripten_resize_heap,
        kg: _emscripten_resume_main_loop,
        Yc: _emscripten_set_canvas_element_size,
        pa: _emscripten_set_devicemotion_callback_on_thread,
        Gg: _emscripten_set_keydown_callback_on_thread,
        jg: _emscripten_set_keypress_callback_on_thread,
        vg: _emscripten_set_keyup_callback_on_thread,
        Sa: _emscripten_set_main_loop,
        L: _emscripten_set_main_loop_timing,
        _f: _emscripten_set_mousedown_callback_on_thread,
        Ef: _emscripten_set_mousemove_callback_on_thread,
        Pf: _emscripten_set_mouseup_callback_on_thread,
        re: _emscripten_set_pointerlockchange_callback_on_thread,
        Ce: _emscripten_set_touchcancel_callback_on_thread,
        Ye: _emscripten_set_touchend_callback_on_thread,
        Ne: _emscripten_set_touchmove_callback_on_thread,
        hf: _emscripten_set_touchstart_callback_on_thread,
        tf: _emscripten_set_wheel_callback_on_thread,
        rd: _emscripten_sleep,
        Jh: _emscripten_webgl_create_context,
        Ba: _emscripten_webgl_destroy_context,
        Ih: _emscripten_webgl_get_drawing_buffer_size,
    ...
    var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports['Oh'])();
    var _free = (Module['_free'] = (a0) =>
      (_free = Module['_free'] = wasmExports['Qh'])(a0));
    var _cmd_take_screenshot = (Module['_cmd_take_screenshot'] = () =>
      (_cmd_take_screenshot = Module['_cmd_take_screenshot'] =
        wasmExports['Rh'])());
    var _get_current_frame_count = (Module['_get_current_frame_count'] = () =>
      (_get_current_frame_count = Module['_get_current_frame_count'] =
        wasmExports['Sh'])());
    var _save_file_path = (Module['_save_file_path'] = () =>
      (_save_file_path = Module['_save_file_path'] = wasmExports['Th'])());
    var _toggleMainLoop = (Module['_toggleMainLoop'] = (a0) =>
      (_toggleMainLoop = Module['_toggleMainLoop'] = wasmExports['Uh'])(a0));
    var _load_state = (Module['_load_state'] = (a0, a1) =>
      (_load_state = Module['_load_state'] = wasmExports['Vh'])(a0, a1));
    var _system_restart = (Module['_system_restart'] = () =>
      (_system_restart = Module['_system_restart'] = wasmExports['Wh'])());
    var _get_disk_count = (Module['_get_disk_count'] = () =>
      (_get_disk_count = Module['_get_disk_count'] = wasmExports['Xh'])());
    var _set_current_disk = (Module['_set_current_disk'] = (a0) =>
      (_set_current_disk = Module['_set_current_disk'] = wasmExports['Yh'])(
        a0,
      ));
    var _get_current_disk = (Module['_get_current_disk'] = () =>
      (_get_current_disk = Module['_get_current_disk'] = wasmExports['Zh'])());
    var _toggle_fastforward = (Module['_toggle_fastforward'] = (a0) =>
      (_toggle_fastforward = Module['_toggle_fastforward'] = wasmExports['_h'])(
        a0,
      ));
    var _set_ff_ratio = (Module['_set_ff_ratio'] = (a0) =>
      (_set_ff_ratio = Module['_set_ff_ratio'] = wasmExports['$h'])(a0));
    var _toggle_slow_motion = (Module['_toggle_slow_motion'] = (a0) =>
      (_toggle_slow_motion = Module['_toggle_slow_motion'] = wasmExports['ai'])(
        a0,
      ));
    var _set_sm_ratio = (Module['_set_sm_ratio'] = (a0) =>
      (_set_sm_ratio = Module['_set_sm_ratio'] = wasmExports['bi'])(a0));
    var _toggle_rewind = (Module['_toggle_rewind'] = (a0) =>
      (_toggle_rewind = Module['_toggle_rewind'] = wasmExports['ci'])(a0));
    var _set_rewind_granularity = (Module['_set_rewind_granularity'] = (a0) =>
      (_set_rewind_granularity = Module['_set_rewind_granularity'] =
        wasmExports['di'])(a0));
    var _malloc = (Module['_malloc'] = (a0) =>
      (_malloc = Module['_malloc'] = wasmExports['ei'])(a0));
    var _ejs_set_variable = (Module['_ejs_set_variable'] = (a0, a1) =>
      (_ejs_set_variable = Module['_ejs_set_variable'] = wasmExports['fi'])(
        a0,
        a1,
      ));
    var _get_core_options = (Module['_get_core_options'] = () =>
      (_get_core_options = Module['_get_core_options'] = wasmExports['gi'])());
    var _set_video_rotation = (Module['_set_video_rotation'] = (a0) =>
      (_set_video_rotation = Module['_set_video_rotation'] = wasmExports['hi'])(
        a0,
      ));
    var _get_video_dimensions = (Module['_get_video_dimensions'] = (a0) =>
      (_get_video_dimensions = Module['_get_video_dimensions'] =
        wasmExports['ii'])(a0));
    var _shader_enable = (Module['_shader_enable'] = (a0) =>
      (_shader_enable = Module['_shader_enable'] = wasmExports['ji'])(a0));
    var _save_state_info = (Module['_save_state_info'] = () =>
      (_save_state_info = Module['_save_state_info'] = wasmExports['ki'])());
    var _supports_states = (Module['_supports_states'] = () =>
      (_supports_states = Module['_supports_states'] = wasmExports['li'])());
    var _refresh_save_files = (Module['_refresh_save_files'] = () =>
      (_refresh_save_files = Module['_refresh_save_files'] =
        wasmExports['mi'])());
    var _ejs_set_keyboard_enabled = (Module['_ejs_set_keyboard_enabled'] = (
      a0,
    ) =>
      (_ejs_set_keyboard_enabled = Module['_ejs_set_keyboard_enabled'] =
        wasmExports['ni'])(a0));
    var _simulate_input = (Module['_simulate_input'] = (a0, a1, a2) =>
      (_simulate_input = Module['_simulate_input'] = wasmExports['oi'])(
        a0,
        a1,
        a2,
      ));
    var _cmd_savefiles = (Module['_cmd_savefiles'] = () =>
      (_cmd_savefiles = Module['_cmd_savefiles'] = wasmExports['pi'])());
    var _cmd_save_state = (Module['_cmd_save_state'] = () =>
      (_cmd_save_state = Module['_cmd_save_state'] = wasmExports['qi'])());
    var _set_cheat = (Module['_set_cheat'] = (a0, a1, a2) =>
      (_set_cheat = Module['_set_cheat'] = wasmExports['ri'])(a0, a1, a2));
    var _reset_cheat = (Module['_reset_cheat'] = () =>
      (_reset_cheat = Module['_reset_cheat'] = wasmExports['si'])());
    var _set_vsync = (Module['_set_vsync'] = (a0) =>
      (_set_vsync = Module['_set_vsync'] = wasmExports['ti'])(a0));
    var _platform_emscripten_update_canvas_dimensions_cb = (a0, a1, a2) =>
      (_platform_emscripten_update_canvas_dimensions_cb = wasmExports['ui'])(
        a0,
        a1,
        a2,
      );
    var _platform_emscripten_update_window_hidden_cb = (a0) =>
      (_platform_emscripten_update_window_hidden_cb = wasmExports['vi'])(a0);
    var _platform_emscripten_update_power_state_cb = (a0, a1, a2, a3) =>
      (_platform_emscripten_update_power_state_cb = wasmExports['wi'])(
        a0,
        a1,
        a2,
        a3,
      );
    var _platform_emscripten_update_memory_usage_cb = (a0, a1) =>
      (_platform_emscripten_update_memory_usage_cb = wasmExports['xi'])(a0, a1);
    var _platform_emscripten_update_fullscreen_state_cb = (a0) =>
      (_platform_emscripten_update_fullscreen_state_cb = wasmExports['yi'])(a0);
    var _platform_emscripten_gl_context_lost_cb = () =>
      (_platform_emscripten_gl_context_lost_cb = wasmExports['zi'])();
    var _platform_emscripten_gl_context_restored_cb = () =>
      (_platform_emscripten_gl_context_restored_cb = wasmExports['Ai'])();
    var _platform_emscripten_command_raise_flag = () =>
      (_platform_emscripten_command_raise_flag = wasmExports['Bi'])();
    var _main = (Module['_main'] = (a0, a1) =>
      (_main = Module['_main'] = wasmExports['Ci'])(a0, a1));
    var _pthread_self = () => (_pthread_self = wasmExports['Di'])();
    var _htons = (a0) => (_htons = wasmExports['Ei'])(a0);
    var _ntohs = (a0) => (_ntohs = wasmExports['Fi'])(a0);
    var _htonl = (a0) => (_htonl = wasmExports['Gi'])(a0);
    var __emscripten_tls_init = () =>
      (__emscripten_tls_init = wasmExports['Hi'])();
    var __emscripten_run_callback_on_thread = (a0, a1, a2, a3, a4) =>
      (__emscripten_run_callback_on_thread = wasmExports['Ii'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var __emscripten_thread_init = (a0, a1, a2, a3, a4, a5) =>
      (__emscripten_thread_init = wasmExports['Ji'])(a0, a1, a2, a3, a4, a5);
    var __emscripten_thread_crashed = () =>
      (__emscripten_thread_crashed = wasmExports['Ki'])();
    var __emscripten_run_on_main_thread_js = (a0, a1, a2, a3, a4) =>
      (__emscripten_run_on_main_thread_js = wasmExports['Li'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var __emscripten_thread_free_data = (a0) =>
      (__emscripten_thread_free_data = wasmExports['Mi'])(a0);
    var __emscripten_thread_exit = (a0) =>
      (__emscripten_thread_exit = wasmExports['Ni'])(a0);
    var __emscripten_check_mailbox = () =>
      (__emscripten_check_mailbox = wasmExports['Oi'])();
    var _setThrew = (a0, a1) => (_setThrew = wasmExports['Pi'])(a0, a1);
    var _emscripten_stack_set_limits = (a0, a1) =>
      (_emscripten_stack_set_limits = wasmExports['Qi'])(a0, a1);
    var __emscripten_stack_restore = (a0) =>
      (__emscripten_stack_restore = wasmExports['Ri'])(a0);
    var __emscripten_stack_alloc = (a0) =>
      (__emscripten_stack_alloc = wasmExports['Si'])(a0);
    var _emscripten_stack_get_current = () =>
      (_emscripten_stack_get_current = wasmExports['Ti'])();
    var dynCall_v = (Module['dynCall_v'] = (a0) =>
      (dynCall_v = Module['dynCall_v'] = wasmExports['Ui'])(a0));
    var dynCall_viiii = (Module['dynCall_viiii'] = (a0, a1, a2, a3, a4) =>
      (dynCall_viiii = Module['dynCall_viiii'] = wasmExports['Vi'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_i = (Module['dynCall_i'] = (a0) =>
      (dynCall_i = Module['dynCall_i'] = wasmExports['Wi'])(a0));
    var dynCall_ii = (Module['dynCall_ii'] = (a0, a1) =>
      (dynCall_ii = Module['dynCall_ii'] = wasmExports['Xi'])(a0, a1));
    var dynCall_vii = (Module['dynCall_vii'] = (a0, a1, a2) =>
      (dynCall_vii = Module['dynCall_vii'] = wasmExports['Yi'])(a0, a1, a2));
    var dynCall_iiii = (Module['dynCall_iiii'] = (a0, a1, a2, a3) =>
      (dynCall_iiii = Module['dynCall_iiii'] = wasmExports['Zi'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_iiiiii = (Module['dynCall_iiiiii'] = (a0, a1, a2, a3, a4, a5) =>
      (dynCall_iiiiii = Module['dynCall_iiiiii'] = wasmExports['_i'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_vi = (Module['dynCall_vi'] = (a0, a1) =>
      (dynCall_vi = Module['dynCall_vi'] = wasmExports['$i'])(a0, a1));
    var dynCall_viii = (Module['dynCall_viii'] = (a0, a1, a2, a3) =>
      (dynCall_viii = Module['dynCall_viii'] = wasmExports['aj'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_iiiii = (Module['dynCall_iiiii'] = (a0, a1, a2, a3, a4) =>
      (dynCall_iiiii = Module['dynCall_iiiii'] = wasmExports['bj'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_iii = (Module['dynCall_iii'] = (a0, a1, a2) =>
      (dynCall_iii = Module['dynCall_iii'] = wasmExports['cj'])(a0, a1, a2));
    ...
    var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = (
      ...
      (dynCall_iiiiiii = Module['dynCall_iiiiiii'] = wasmExports['dj'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_iijijii = (Module['dynCall_iijijii'] = (
      a0,
      a1,
      a2,
      a3,
      ...
      (dynCall_iijijii = Module['dynCall_iijijii'] =
        wasmExports['dynCall_iijijii'])(a0, a1, a2, a3, a4, a5, a6));
    ...
    var dynCall_iiiiijiii = (Module['dynCall_iiiiijiii'] = (
      ...
      (dynCall_iiiiijiii = Module['dynCall_iiiiijiii'] =
        wasmExports['dynCall_iiiiijiii'])(a0, a1, a2, a3, a4, a5, a6, a7, a8));
    var dynCall_fffff = (Module['dynCall_fffff'] = (a0, a1, a2, a3, a4) =>
      (dynCall_fffff = Module['dynCall_fffff'] = wasmExports['dynCall_fffff'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_iiiiifii = (Module['dynCall_iiiiifii'] = (
      ...
      (dynCall_iiiiifii = Module['dynCall_iiiiifii'] =
        wasmExports['dynCall_iiiiifii'])(a0, a1, a2, a3, a4, a5, a6, a7));
    ...
    var dynCall_iji = (Module['dynCall_iji'] = (a0, a1, a2) =>
    ...
    var dynCall_viiffff = (Module['dynCall_viiffff'] = (
      ...
      (dynCall_viiffff = Module['dynCall_viiffff'] =
        wasmExports['dynCall_viiffff'])(a0, a1, a2, a3, a4, a5, a6));
    ...
    var dynCall_viiiiif = (Module['dynCall_viiiiif'] = (
      ...
      (dynCall_viiiiif = Module['dynCall_viiiiif'] =
        wasmExports['dynCall_viiiiif'])(a0, a1, a2, a3, a4, a5, a6));
    ...
    var dynCall_vffff = (Module['dynCall_vffff'] = (a0, a1, a2, a3, a4) =>
      (dynCall_vffff = Module['dynCall_vffff'] = wasmExports['dynCall_vffff'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_vf = (Module['dynCall_vf'] = (a0, a1) =>
      (dynCall_vf = Module['dynCall_vf'] = wasmExports['dynCall_vf'])(a0, a1));
    var dynCall_vff = (Module['dynCall_vff'] = (a0, a1, a2) =>
      (dynCall_vff = Module['dynCall_vff'] = wasmExports['dynCall_vff'])(
        a0,
        a1,
        a2,
      ));
    var dynCall_vfi = (Module['dynCall_vfi'] = (a0, a1, a2) =>
      (dynCall_vfi = Module['dynCall_vfi'] = wasmExports['dynCall_vfi'])(
        a0,
        a1,
        a2,
      ));
    var dynCall_viff = (Module['dynCall_viff'] = (a0, a1, a2, a3) =>
      (dynCall_viff = Module['dynCall_viff'] = wasmExports['dynCall_viff'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_vifff = (Module['dynCall_vifff'] = (a0, a1, a2, a3, a4) =>
      (dynCall_vifff = Module['dynCall_vifff'] = wasmExports['dynCall_vifff'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_viffff = (Module['dynCall_viffff'] = (a0, a1, a2, a3, a4, a5) =>
      (dynCall_viffff = Module['dynCall_viffff'] =
        wasmExports['dynCall_viffff'])(a0, a1, a2, a3, a4, a5));
    var dynCall_vfff = (Module['dynCall_vfff'] = (a0, a1, a2, a3) =>
      (dynCall_vfff = Module['dynCall_vfff'] = wasmExports['dynCall_vfff'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var dynCall_viifi = (Module['dynCall_viifi'] = (a0, a1, a2, a3, a4) =>
      (dynCall_viifi = Module['dynCall_viifi'] = wasmExports['dynCall_viifi'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var _asyncify_start_unwind = (a0) =>
      (_asyncify_start_unwind = wasmExports['ej'])(a0);
    var _asyncify_stop_unwind = () =>
      (_asyncify_stop_unwind = wasmExports['fj'])();
    var _asyncify_start_rewind = (a0) =>
      (_asyncify_start_rewind = wasmExports['gj'])(a0);
    var _asyncify_stop_rewind = () =>
      (_asyncify_stop_rewind = wasmExports['hj'])();
    ...
    function applySignatureConversions(wasmExports) {
      ...
      wasmExports['ei'] = makeWrapper_pp(wasmExports['ei']);
      wasmExports['Di'] = makeWrapper_p(wasmExports['Di']);
      wasmExports['Si'] = makeWrapper_pp(wasmExports['Si']);
      wasmExports['Ti'] = makeWrapper_p(wasmExports['Ti']);
      return wasmExports;
    }
