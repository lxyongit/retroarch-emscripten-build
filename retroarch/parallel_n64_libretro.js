...
var EJS_Runtime = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      return locateFile('parallel_n64_libretro.wasm');
    }
    ...
    var ASM_CONSTS = {
      ...
      530397: () => Atomics?.waitAsync?.toString().includes('[native code]'),
      530466: ($0) => {
    ...
    var wasmImports = {
      ob: _PlatformEmscriptenGLContextEventInit,
      kc: _PlatformEmscriptenGetSystemInfo,
      zb: _PlatformEmscriptenMemoryUsageInit,
      Kb: _PlatformEmscriptenPowerStateInit,
      vc: _PlatformEmscriptenSetCanvasSize,
      Gc: _PlatformEmscriptenSetWakeLock,
      $b: _PlatformEmscriptenWatchCanvasSizeAndDpr,
      pb: _PlatformEmscriptenWatchFullscreen,
      Ub: _PlatformEmscriptenWatchWindowVisibility,
      K: ___assert_fail,
      xb: ___syscall_accept4,
      wb: ___syscall_bind,
      vb: ___syscall_connect,
      w: ___syscall_fcntl64,
      Tb: ___syscall_ftruncate64,
      Sb: ___syscall_getcwd,
      Hb: ___syscall_getdents64,
      ub: ___syscall_getsockname,
      tb: ___syscall_getsockopt,
      Vb: ___syscall_ioctl,
      sb: ___syscall_listen,
      Ob: ___syscall_mkdirat,
      Ma: ___syscall_openat,
      Ib: ___syscall_poll,
      Gb: ___syscall_readlinkat,
      rb: ___syscall_recvfrom,
      Db: ___syscall_renameat,
      Eb: ___syscall_rmdir,
      qb: ___syscall_sendto,
      ...
      ia: _alGetSourcei,
      gb: _alSourcePlay,
      hb: _alSourceQueueBuffers,
      fb: _alSourceStop,
      Ia: _alSourceUnqueueBuffers,
      bb: _alcCloseDevice,
      lb: _alcCreateContext,
      cb: _alcDestroyContext,
      Ja: _alcMakeContextCurrent,
      mb: _alcOpenDevice,
      Xb: _clock_time_get,
      sa: _emscripten_asm_const_int,
      ka: _emscripten_asm_const_int_sync_on_main_thread,
      Gh: _emscripten_asm_const_ptr,
      vd: _emscripten_async_call,
      Mh: _emscripten_async_wget2_data,
      Wb: _emscripten_date_now,
      Rc: _emscripten_exit_fullscreen,
      ue: _emscripten_exit_pointerlock,
      Lh: _emscripten_fiber_swap,
      Vh: _emscripten_force_exit,
      Bb: _emscripten_get_heap_max,
      jh: _emscripten_glActiveTexture,
      ih: _emscripten_glAttachShader,
      Yd: _emscripten_glBeginQuery,
      ...
      xd: _emscripten_glBindBufferBase,
      yd: _emscripten_glBindBufferRange,
      fh: _emscripten_glBindFramebuffer,
      eh: _emscripten_glBindRenderbuffer,
      Bc: _emscripten_glBindSampler,
      dh: _emscripten_glBindTexture,
      sc: _emscripten_glBindTransformFeedback,
      Fd: _emscripten_glBindVertexArray,
      sh: _emscripten_glBindVertexArrayOES,
      bh: _emscripten_glBlendColor,
      ah: _emscripten_glBlendEquation,
      $g: _emscripten_glBlendEquationSeparate,
      _g: _emscripten_glBlendFunc,
      ...
      _c: _emscripten_glClearBufferfi,
      $c: _emscripten_glClearBufferfv,
      cd: _emscripten_glClearBufferiv,
      bd: _emscripten_glClearBufferuiv,
      Ug: _emscripten_glClearColor,
      Rg: _emscripten_glClearDepthf,
      Qg: _emscripten_glClearStencil,
      Lc: _emscripten_glClientWaitSync,
      ne: _emscripten_glClipControlEXT,
      ...
      Yc: _emscripten_glCopyBufferSubData,
      Lg: _emscripten_glCopyTexImage2D,
      Kg: _emscripten_glCopyTexSubImage2D,
      ce: _emscripten_glCopyTexSubImage3D,
      Jg: _emscripten_glCreateProgram,
      Ig: _emscripten_glCreateShader,
      Gg: _emscripten_glCullFace,
      Fg: _emscripten_glDeleteBuffers,
      Eg: _emscripten_glDeleteFramebuffers,
      Dg: _emscripten_glDeleteProgram,
      _d: _emscripten_glDeleteQueries,
      Ch: _emscripten_glDeleteQueriesEXT,
      Cg: _emscripten_glDeleteRenderbuffers,
      Dc: _emscripten_glDeleteSamplers,
      Bg: _emscripten_glDeleteShader,
      Mc: _emscripten_glDeleteSync,
      Ag: _emscripten_glDeleteTextures,
      rc: _emscripten_glDeleteTransformFeedbacks,
      Ed: _emscripten_glDeleteVertexArrays,
      rh: _emscripten_glDeleteVertexArraysOES,
      zg: _emscripten_glDepthFunc,
      yg: _emscripten_glDepthMask,
      xg: _emscripten_glDepthRangef,
      vg: _emscripten_glDetachShader,
      ug: _emscripten_glDisable,
      tg: _emscripten_glDisableVertexAttribArray,
      sg: _emscripten_glDrawArrays,
      Qc: _emscripten_glDrawArraysInstanced,
      mh: _emscripten_glDrawArraysInstancedANGLE,
      ac: _emscripten_glDrawArraysInstancedARB,
      ke: _emscripten_glDrawArraysInstancedEXT,
      bc: _emscripten_glDrawArraysInstancedNV,
      Sd: _emscripten_glDrawBuffers,
      he: _emscripten_glDrawBuffersEXT,
      oh: _emscripten_glDrawBuffersWEBGL,
      rg: _emscripten_glDrawElements,
      Pc: _emscripten_glDrawElementsInstanced,
      lh: _emscripten_glDrawElementsInstancedANGLE,
      Zb: _emscripten_glDrawElementsInstancedARB,
      _b: _emscripten_glDrawElementsInstancedEXT,
      ...
      Xd: _emscripten_glEndQuery,
      zh: _emscripten_glEndQueryEXT,
      zd: _emscripten_glEndTransformFeedback,
      Oc: _emscripten_glFenceSync,
      og: _emscripten_glFinish,
      ng: _emscripten_glFlush,
      Hd: _emscripten_glFlushMappedBufferRange,
      mg: _emscripten_glFramebufferRenderbuffer,
      kg: _emscripten_glFramebufferTexture2D,
      Jd: _emscripten_glFramebufferTextureLayer,
      jg: _emscripten_glFrontFace,
      ig: _emscripten_glGenBuffers,
      gg: _emscripten_glGenFramebuffers,
      $d: _emscripten_glGenQueries,
      Dh: _emscripten_glGenQueriesEXT,
      fg: _emscripten_glGenRenderbuffers,
      Ec: _emscripten_glGenSamplers,
      eg: _emscripten_glGenTextures,
      qc: _emscripten_glGenTransformFeedbacks,
      Dd: _emscripten_glGenVertexArrays,
      qh: _emscripten_glGenVertexArraysOES,
      hg: _emscripten_glGenerateMipmap,
      dg: _emscripten_glGetActiveAttrib,
      cg: _emscripten_glGetActiveUniform,
      Tc: _emscripten_glGetActiveUniformBlockName,
      Uc: _emscripten_glGetActiveUniformBlockiv,
      Wc: _emscripten_glGetActiveUniformsiv,
      bg: _emscripten_glGetAttachedShaders,
      $f: _emscripten_glGetAttribLocation,
      _f: _emscripten_glGetBooleanv,
      Fc: _emscripten_glGetBufferParameteri64v,
      Zf: _emscripten_glGetBufferParameteriv,
      Td: _emscripten_glGetBufferPointerv,
      Yf: _emscripten_glGetError,
      Xf: _emscripten_glGetFloatv,
      ld: _emscripten_glGetFragDataLocation,
      Wf: _emscripten_glGetFramebufferAttachmentParameteriv,
      Hc: _emscripten_glGetInteger64i_v,
      Jc: _emscripten_glGetInteger64v,
      Bd: _emscripten_glGetIntegeri_v,
      Vf: _emscripten_glGetIntegerv,
      ec: _emscripten_glGetInternalformativ,
      mc: _emscripten_glGetProgramBinary,
      Tf: _emscripten_glGetProgramInfoLog,
      Uf: _emscripten_glGetProgramiv,
      uh: _emscripten_glGetQueryObjecti64vEXT,
      wh: _emscripten_glGetQueryObjectivEXT,
      th: _emscripten_glGetQueryObjectui64vEXT,
      Vd: _emscripten_glGetQueryObjectuiv,
      vh: _emscripten_glGetQueryObjectuivEXT,
      Wd: _emscripten_glGetQueryiv,
      xh: _emscripten_glGetQueryivEXT,
      Sf: _emscripten_glGetRenderbufferParameteriv,
      uc: _emscripten_glGetSamplerParameterfv,
      ...
      Qf: _emscripten_glGetShaderiv,
      Mf: _emscripten_glGetString,
      Zc: _emscripten_glGetStringi,
      ...
      Vc: _emscripten_glGetUniformBlockIndex,
      Xc: _emscripten_glGetUniformIndices,
      Hf: _emscripten_glGetUniformLocation,
      Jf: _emscripten_glGetUniformfv,
      If: _emscripten_glGetUniformiv,
      md: _emscripten_glGetUniformuiv,
      sd: _emscripten_glGetVertexAttribIiv,
      rd: _emscripten_glGetVertexAttribIuiv,
      Df: _emscripten_glGetVertexAttribPointerv,
      Ff: _emscripten_glGetVertexAttribfv,
      Ef: _emscripten_glGetVertexAttribiv,
      Cf: _emscripten_glHint,
      ic: _emscripten_glInvalidateFramebuffer,
      hc: _emscripten_glInvalidateSubFramebuffer,
      Bf: _emscripten_glIsBuffer,
      Af: _emscripten_glIsEnabled,
      zf: _emscripten_glIsFramebuffer,
      yf: _emscripten_glIsProgram,
      Zd: _emscripten_glIsQuery,
      Bh: _emscripten_glIsQueryEXT,
      xf: _emscripten_glIsRenderbuffer,
      Cc: _emscripten_glIsSampler,
      wf: _emscripten_glIsShader,
      Nc: _emscripten_glIsSync,
      uf: _emscripten_glIsTexture,
      pc: _emscripten_glIsTransformFeedback,
      Cd: _emscripten_glIsVertexArray,
      ph: _emscripten_glIsVertexArrayOES,
      tf: _emscripten_glLineWidth,
      sf: _emscripten_glLinkProgram,
      Id: _emscripten_glMapBufferRange,
      oc: _emscripten_glPauseTransformFeedback,
      rf: _emscripten_glPixelStorei,
      me: _emscripten_glPolygonModeWEBGL,
      qf: _emscripten_glPolygonOffset,
      oe: _emscripten_glPolygonOffsetClampEXT,
      lc: _emscripten_glProgramBinary,
      jc: _emscripten_glProgramParameteri,
      yh: _emscripten_glQueryCounterEXT,
      ...
      Kd: _emscripten_glRenderbufferStorageMultisample,
      nc: _emscripten_glResumeTransformFeedback,
      mf: _emscripten_glSampleCoverage,
      yc: _emscripten_glSamplerParameterf,
      xc: _emscripten_glSamplerParameterfv,
      Ac: _emscripten_glSamplerParameteri,
      zc: _emscripten_glSamplerParameteriv,
      lf: _emscripten_glScissor,
      jf: _emscripten_glShaderBinary,
      hf: _emscripten_glShaderSource,
      gf: _emscripten_glStencilFunc,
      ff: _emscripten_glStencilFuncSeparate,
      ef: _emscripten_glStencilMask,
      df: _emscripten_glStencilMaskSeparate,
      cf: _emscripten_glStencilOp,
      bf: _emscripten_glStencilOpSeparate,
      af: _emscripten_glTexImage2D,
      ee: _emscripten_glTexImage3D,
      $e: _emscripten_glTexParameterf,
      Ze: _emscripten_glTexParameterfv,
      Ye: _emscripten_glTexParameteri,
      Xe: _emscripten_glTexParameteriv,
      gc: _emscripten_glTexStorage2D,
      fc: _emscripten_glTexStorage3D,
      We: _emscripten_glTexSubImage2D,
      de: _emscripten_glTexSubImage3D,
      wd: _emscripten_glTransformFeedbackVaryings,
      Ve: _emscripten_glUniform1f,
      Ue: _emscripten_glUniform1fv,
      Te: _emscripten_glUniform1i,
      Se: _emscripten_glUniform1iv,
      kd: _emscripten_glUniform1ui,
      gd: _emscripten_glUniform1uiv,
      Re: _emscripten_glUniform2f,
      Qe: _emscripten_glUniform2fv,
      Pe: _emscripten_glUniform2i,
      Oe: _emscripten_glUniform2iv,
      jd: _emscripten_glUniform2ui,
      fd: _emscripten_glUniform2uiv,
      Ne: _emscripten_glUniform3f,
      Me: _emscripten_glUniform3fv,
      Le: _emscripten_glUniform3i,
      Ke: _emscripten_glUniform3iv,
      id: _emscripten_glUniform3ui,
      ...
      hd: _emscripten_glUniform4ui,
      dd: _emscripten_glUniform4uiv,
      Sc: _emscripten_glUniformBlockBinding,
      Ee: _emscripten_glUniformMatrix2fv,
      Rd: _emscripten_glUniformMatrix2x3fv,
      Pd: _emscripten_glUniformMatrix2x4fv,
      De: _emscripten_glUniformMatrix3fv,
      ...
      Ud: _emscripten_glUnmapBuffer,
      Be: _emscripten_glUseProgram,
      Ae: _emscripten_glValidateProgram,
      ze: _emscripten_glVertexAttrib1f,
      ye: _emscripten_glVertexAttrib1fv,
      xe: _emscripten_glVertexAttrib2f,
      we: _emscripten_glVertexAttrib2fv,
      ve: _emscripten_glVertexAttrib3f,
      te: _emscripten_glVertexAttrib3fv,
      se: _emscripten_glVertexAttrib4f,
      re: _emscripten_glVertexAttrib4fv,
      tc: _emscripten_glVertexAttribDivisor,
      kh: _emscripten_glVertexAttribDivisorANGLE,
      cc: _emscripten_glVertexAttribDivisorARB,
      ...
      td: _emscripten_glVertexAttribIPointer,
      qe: _emscripten_glVertexAttribPointer,
      pe: _emscripten_glViewport,
      Kc: _emscripten_glWaitSync,
      je: _emscripten_html5_remove_all_event_listeners,
      Wh: _emscripten_pause_main_loop,
      ad: _emscripten_request_fullscreen,
      Fe: _emscripten_request_pointerlock,
      Ab: _emscripten_resize_heap,
      Tg: _emscripten_resume_main_loop,
      Gd: _emscripten_set_canvas_element_size,
      Na: _emscripten_set_devicemotion_callback_on_thread,
      nh: _emscripten_set_keydown_callback_on_thread,
      Sg: _emscripten_set_keypress_callback_on_thread,
      ch: _emscripten_set_keyup_callback_on_thread,
      nb: _emscripten_set_main_loop,
      Z: _emscripten_set_main_loop_timing,
      Hg: _emscripten_set_mousedown_callback_on_thread,
      lg: _emscripten_set_mousemove_callback_on_thread,
      wg: _emscripten_set_mouseup_callback_on_thread,
      _e: _emscripten_set_pointerlockchange_callback_on_thread,
      kf: _emscripten_set_touchcancel_callback_on_thread,
      Gf: _emscripten_set_touchend_callback_on_thread,
      vf: _emscripten_set_touchmove_callback_on_thread,
      Rf: _emscripten_set_touchstart_callback_on_thread,
      ag: _emscripten_set_wheel_callback_on_thread,
      ja: _emscripten_sleep,
      Sh: _emscripten_webgl_create_context,
      Ya: _emscripten_webgl_destroy_context,
      Rh: _emscripten_webgl_get_drawing_buffer_size,
      ...
      Kh: _glLineWidth,
      Ca: _glLinkProgram,
      ab: _glMapBufferRange,
      r: _glPixelStorei,
      va: _glPolygonOffset,
      V: _glReadPixels,
      _a: _glRenderbufferStorage,
      ha: _glScissor,
      aa: _glShaderSource,
      Qa: _glStencilFunc,
      Ta: _glStencilMask,
    ...
    var ___wasm_call_ctors = wasmExports['Yh'];
    var _free = (Module['_free'] = wasmExports['_h']);
    var _cmd_take_screenshot = (Module['_cmd_take_screenshot'] =
      wasmExports['$h']);
    var _get_current_frame_count = (Module['_get_current_frame_count'] =
      wasmExports['ai']);
    var _save_file_path = (Module['_save_file_path'] = wasmExports['bi']);
    var _toggleMainLoop = (Module['_toggleMainLoop'] = wasmExports['ci']);
    var _load_state = (Module['_load_state'] = wasmExports['di']);
    var _system_restart = (Module['_system_restart'] = wasmExports['ei']);
    var _get_disk_count = (Module['_get_disk_count'] = wasmExports['fi']);
    var _set_current_disk = (Module['_set_current_disk'] = wasmExports['gi']);
    var _get_current_disk = (Module['_get_current_disk'] = wasmExports['hi']);
    var _toggle_fastforward = (Module['_toggle_fastforward'] =
      wasmExports['ii']);
    var _set_ff_ratio = (Module['_set_ff_ratio'] = wasmExports['ji']);
    var _toggle_slow_motion = (Module['_toggle_slow_motion'] =
      wasmExports['ki']);
    var _set_sm_ratio = (Module['_set_sm_ratio'] = wasmExports['li']);
    var _toggle_rewind = (Module['_toggle_rewind'] = wasmExports['mi']);
    var _set_rewind_granularity = (Module['_set_rewind_granularity'] =
      wasmExports['ni']);
    var _malloc = (Module['_malloc'] = wasmExports['oi']);
    var _ejs_set_variable = (Module['_ejs_set_variable'] = wasmExports['pi']);
    var _get_core_options = (Module['_get_core_options'] = wasmExports['qi']);
    var _set_video_rotation = (Module['_set_video_rotation'] =
      wasmExports['ri']);
    var _get_video_dimensions = (Module['_get_video_dimensions'] =
      wasmExports['si']);
    var _shader_enable = (Module['_shader_enable'] = wasmExports['ti']);
    var _save_state_info = (Module['_save_state_info'] = wasmExports['ui']);
    var _supports_states = (Module['_supports_states'] = wasmExports['vi']);
    var _refresh_save_files = (Module['_refresh_save_files'] =
      wasmExports['wi']);
    var _ejs_set_keyboard_enabled = (Module['_ejs_set_keyboard_enabled'] =
      wasmExports['xi']);
    var _simulate_input = (Module['_simulate_input'] = wasmExports['yi']);
    var _cmd_savefiles = (Module['_cmd_savefiles'] = wasmExports['zi']);
    var _cmd_save_state = (Module['_cmd_save_state'] = wasmExports['Ai']);
    var _set_cheat = (Module['_set_cheat'] = wasmExports['Bi']);
    var _reset_cheat = (Module['_reset_cheat'] = wasmExports['Ci']);
    var _set_vsync = (Module['_set_vsync'] = wasmExports['Di']);
    var _platform_emscripten_update_canvas_dimensions_cb = wasmExports['Ei'];
    var _platform_emscripten_update_window_hidden_cb = wasmExports['Fi'];
    var _platform_emscripten_update_power_state_cb = wasmExports['Gi'];
    var _platform_emscripten_update_memory_usage_cb = wasmExports['Hi'];
    var _platform_emscripten_update_fullscreen_state_cb = wasmExports['Ii'];
    var _platform_emscripten_gl_context_lost_cb = wasmExports['Ji'];
    var _platform_emscripten_gl_context_restored_cb = wasmExports['Ki'];
    var _platform_emscripten_command_raise_flag = wasmExports['Li'];
    var _main = (Module['_main'] = wasmExports['Mi']);
    var _htons = wasmExports['Ni'];
    var _ntohs = wasmExports['Oi'];
    var _htonl = wasmExports['Pi'];
    var _emscripten_builtin_memalign = wasmExports['Qi'];
    var _setThrew = wasmExports['Ri'];
    var _emscripten_stack_set_limits = wasmExports['Si'];
    var __emscripten_stack_restore = wasmExports['Ti'];
    var __emscripten_stack_alloc = wasmExports['Ui'];
    var _emscripten_stack_get_current = wasmExports['Vi'];
    var dynCall_v = (Module['dynCall_v'] = wasmExports['Wi']);
    var dynCall_viiii = (Module['dynCall_viiii'] = wasmExports['Xi']);
    var dynCall_i = (Module['dynCall_i'] = wasmExports['Yi']);
    var dynCall_ii = (Module['dynCall_ii'] = wasmExports['Zi']);
    var dynCall_vii = (Module['dynCall_vii'] = wasmExports['_i']);
    var dynCall_iiii = (Module['dynCall_iiii'] = wasmExports['$i']);
    var dynCall_iiiiii = (Module['dynCall_iiiiii'] = wasmExports['aj']);
    var dynCall_vi = (Module['dynCall_vi'] = wasmExports['bj']);
    var dynCall_viii = (Module['dynCall_viii'] = wasmExports['cj']);
    var dynCall_iiiii = (Module['dynCall_iiiii'] = wasmExports['dj']);
    var dynCall_iii = (Module['dynCall_iii'] = wasmExports['ej']);
    var dynCall_viiiii = (Module['dynCall_viiiii'] =
      wasmExports['dynCall_viiiii']);
    var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = wasmExports['fj']);
    ...
    var dynCall_iiifi = (Module['dynCall_iiifi'] =
      wasmExports['dynCall_iiifi']);
    var dynCall_viiffff = (Module['dynCall_viiffff'] =
      wasmExports['dynCall_viiffff']);
    ...
    var dynCall_vifff = (Module['dynCall_vifff'] =
      wasmExports['dynCall_vifff']);
    var dynCall_viffff = (Module['dynCall_viffff'] =
      wasmExports['dynCall_viffff']);
    ...
    var dynCall_viifi = (Module['dynCall_viifi'] =
      wasmExports['dynCall_viifi']);
    var dynCall_iidiiii = (Module['dynCall_iidiiii'] =
      wasmExports['dynCall_iidiiii']);
    var _asyncify_start_unwind = wasmExports['gj'];
    var _asyncify_stop_unwind = wasmExports['hj'];
    var _asyncify_start_rewind = wasmExports['ij'];
    var _asyncify_stop_rewind = wasmExports['jj'];
